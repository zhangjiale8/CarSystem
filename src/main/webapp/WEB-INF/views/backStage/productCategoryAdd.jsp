...
<meta http-equiv="Cache-Control" content="no-siteapp" />
 <link href="<%=request.getContextPath()%>/resource/assets/css/bootstrap.min.css" rel="stylesheet" />
        ...
        <link href="<%=request.getContextPath()%>/resource/Widget/icheck/icheck.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/Widget/icheck/jquery.icheck.min.js"></script> 
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/Widget/Validform/5.3.2/Validform.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/assets/layer/layer.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/H-ui.js"></script> 
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/H-ui.admin.js"></script>
