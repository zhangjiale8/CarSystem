...
<link rel="stylesheet"
	href="resource/assets/css/font-awesome.min.css" />
...
<script src="resource/assets/laydate/laydate.js"
	type="text/javascript"></script>
        <script src="<%=request.getContextPath()%>/resource/js/backStage/item/guestBook/guestBookManage.js" type="text/javascript" ></script>   
<title>留言</title>
</head>
...
<div class="margin clearfix">
 ...
 <div class="search_style">
      ...
      <ul class="search_content clearfix">
       <li><label class="l_f">用户名</label><input name="guestBookName" id="userName" type="text" class="text_add" placeholder="输入留言信息" style=" width:200px"></li>
       <li style="width:90px;"><button type="button" id="guestBook_select" class="btn_search"><i class="icon-search"></i>查询</button></li>
      </ul>
    </div>
    <div class="border clearfix">
       <span class="l_f">
        <a href="javascript:void(0)"  class="guestBook_delete btn btn-danger"><i class="fa fa-trash"></i>&nbsp;批量删除</a>
    ...
    <div class="Guestbook_list">
      ...
      <thead>
		 <tr>
          <th width="80"><label><input type="checkbox" id="guestBook_checkAll" class="ace"><span class="lbl"></span></label></th>
          <th >用户名</th>
          <th >留言内容</th>
          <th >时间</th>
          <th >状态</th>                
