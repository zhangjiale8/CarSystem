...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/backStage/item/itemOrder/itemOrderState.js"></script>
<style type="text/css">
.form-horizontal {
	margin-top:20px;
	width: 40%;
...
<body>
	...
	<div id="itemOutLibraryOrder" class="form-horizontal">
		...
		<div class="form-group" style="display: none">
			...
			<div class="col-lg-1">
				<input type="text" class="form-control" name="orderState" id="orderState" value="${itemOrder.orderState }" placeholder="请输入ID">
			</div>
		</div>
		<div class="form-group">
			<label for="firstname" class="col-lg control-label">订单状态:</label>
			<div class="col-lg-1 col-sm" style="margin-left: 10px;">
				<select class="form-control" name="itemOrderState"  id="itemOrderState">
