...
<script src="<%=request.getContextPath()%>/resource/js/backStage/item/guestBook/commentEdit.js"
		...
		<div class="content_style" >
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right"
					for="form-field-1">评论用户 </label>
				<div class="col-sm-9">${comment.userName}</div>
				<input  name="guestBookID" style="display: none" id="guestBookID" value="${comment.commentID }"/>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right"
					for="form-field-1"> 评论内容 </label>
				<div class="col-sm-9">${comment.commentContent }</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right"
				...
				<div class="col-sm-9">
					...
					<div class="Reply_style">
						<textarea name="权限描述" class="form-control" id="form_textarea"
							placeholder="">${comment.replyContent}</textarea>
			...
			<div class="form-group" style="margin-top: 50px">
				<a href="javascript:void(0)"
					...
					<a href="javascript:void(0)" id="rest" class="btn btn-success">取消</a>
			</div>
		</div>
	</div>
</body>
