...
<script type="text/javascript"
	...
	<script type="text/javascript"
	src="<%=request.getContextPath()%>/resource/js/backStage/customer/customerEdit.js"></script>
<style>
.form {
			...
			<ul class='attributes'>
				...
				<li class='attribute'>
					...
					<input type="hidden" name="userID" value="${customer.userID }">
						<input type="text" name="userName" readonly="readonly" value="${customer.userName }" class="w268"
				...
				<li class='attribute'>
					...
					<div class='value'>
						<input type="text" name="userShowName" class="w268"
							data-rule-required="true" value="${customer.userShowName }"/>
					</div>
				</li>
				...
				<li class='attribute'>
					...
					<div class='value'>
						<input type="text" name="userPhone" class="w268"
							data-rule-required="false" value="${customer.userPhone}"/>
					</div>
				</li>
				...
				<li class='attribute'>
					...
					<div class='value'>
						<input type="text" name="userPassWord" class="w268"
							data-rule-required="false" value="${customer.userPassWord}"/>
					</div>
				</li>
