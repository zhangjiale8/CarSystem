...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/backStage/item/repair/repairOrderManage.js"></script>
<title>整车出库单页</title>
			...
			<div class="d_Confirm_Order_style">
				<div class="search_style">
					...
					<ul class="search_content clearfix">
						<li>
							...
							<input name="" type="text" class="text_add" id="repairOrderCode" placeholder="输入订单号" style="width: 200px" />
						</li>
						<li>
							<label class="l_f">车牌号</label>
							<input name="" type="text" class="text_add" id="carCode" placeholder="输入车牌号" style="width: 200px" />
						</li>
						 <li>
						...
						<li style="width: 90px;">
							<button type="button" class="btn_search" id="repairOrder_select">
				...
				<div class="border clearfix">
					<span class="l_f"> <a href="javascript:void(0)"
						id="add_repairOrder" date-class-id="1" class="btn btn-warning"><i class="icon-plus"></i>新增维修订单</a>
						<a href="javascript:void(0)" class="repairOrder_delete btn btn-danger"><i
				...
				<div class="table_menu_list">
					<table class="table table-striped table-bordered table-hover"
						...
						<thead>
							<tr>
								<th ><label><input type="checkbox" id="repairOrder_checkbox"
