			...
			<div class="d_Confirm_Order_style">
				<div class="search_style">
					...
					<ul class="search_content clearfix">
						<li><label class="l_f">客户名称</label><input name="userName" type="text" id="customerName"
							class="text_add" placeholder="输入客户名称" style="width:200px" /></li>
...
<script type="text/javascript" src="resource/js/backStage/customer/customerList.js"></script>