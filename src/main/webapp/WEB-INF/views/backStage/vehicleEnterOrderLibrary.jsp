			...
			<div class="d_Confirm_Order_style">
				...
				<div class="border clearfix enter">
					<span class="l_f"> <a href="javascript:void(0)"
						id="item_enterLibrary" data-class-id="1" class="btn btn-warning"><i class="icon-plus"></i>商品入库</a>
				...
				<div class="border clearfix item">
					<span class="l_f"> <a href="javascript:void(0)"
						id="item_enterLibrary" data-class-id="1" class="btn btn-warning"><i class="icon-picture"></i>商品图片</a>	
					</span> 
				</div>
				<!---->
