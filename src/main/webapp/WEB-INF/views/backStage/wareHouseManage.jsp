...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/backStage/item/wareHouse/wareHouseManage.js"></script>
<title>商品管理</title>
</head>
			...
			<div class="d_Confirm_Order_style">
				<div class="search_style">
					...
					<ul class="search_content clearfix">
						...
						<li style="width: 90px;"><button type="button"
								class="btn_search" id="wareHouse_select">
				...
				<div class="border clearfix">
					<span class="l_f"> <!-- <a href="javascript:void(0)"
						id="add_wareHouse" class="btn btn-warning"><i class="icon-plus"></i>添加仓库</a> -->
						<a href="javascript:void(0)" class="wareHouse_delete btn btn-danger"><i
							class="icon-trash"></i>批量删除</a>
							<a href="javascript:void(0)"  data-class-id="1" id="lookVehicle" class="btn btn-warning"><i
							class="icon-check"></i>整车查看</a>
							<a href="javascript:void(0)" data-class-id="2" id="lookFitting" class="btn btn-info"><i
				...
				<div class="table_menu_list" style="widows: 100%;height: 100%">
					<table class="table table-striped table-bordered table-hover"
						...
						<thead>
							<tr>
								<th width="80"><label><input type="checkbox" id="wareHouse_checkAll"
