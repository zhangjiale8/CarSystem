			...
			<div class="d_Confirm_Order_style">
				<div class="search_style">
					...
					<ul class="search_content clearfix">
						<li><label class="l_f">会员名称</label><input name="userName" type="text" id="userName"
							class="text_add" placeholder="输入会员名称" style="width:200px" /></li>
				...
				<div class="border clearfix">
					<span class="l_f"> <a href="javascript:void(0)"
						...
						<a href="javascript:void(0)" id="userinfo_delete" class="btn btn-danger"><i
...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/backStage/user/userConfig.js"></script>