			...
			<div class="d_Confirm_Order_style">
				...
				<div class="border clearfix">
					<span class="l_f"> <a href="javascript:void(0)"
						id="item_outLibrary" date-class-id="1" class="btn btn-warning"><i class="icon-minus"></i>整车出库</a>
						<a href="javascript:void(0)" class="outLibraryOrder_delete btn btn-danger"><i
							class="icon-trash"></i>批量删除</a>
							<a href="javascript:void(0)" id="outLibrary" data-class-id="1"  class="btn btn-info"><i
							class="icon-check"></i>整车出库单</a>
					</span> 
				</div>
				<!---->
